...
-------------------------------------------------------------------------------""")
        ...
        if student_exists(students_data, name, section):
            ...
            new_student_data ={ "Full Name" : name,
                            "Section" : section,
                            "Grades": {"Spanish": spanish_grade,
...
def view_all_students(students_data):
    ...
    for students in students_data:
        print (f"{students["Full Name"].ljust(30)}{students["Section"].ljust(10)}{str(students["Grades"]["Spanish"]).ljust(10)}{str(students["Grades"]["English"]).ljust(10)}{str(students["Grades"]["Social"]).ljust(10)}{str(students["Grades"]["Science"]).ljust(10)}")
...
{"Full Name".ljust(30)}{"Section".ljust(20)}{"Average Score".ljust(10)}""")
    ...
    for name in students_data[:3]:
        print(f"{name["Full Name"].ljust(30)}{name["Section"].ljust(20)}{(name["Grades"]["Spanish"]+name["Grades"]["English"]+name["Grades"]["Social"]+name["Grades"]["Science"])/4}")
...
{"Full Name".ljust(30)}{"Section".ljust(20)}{"Average Score".ljust(10)}""")
    ...
    students_data.sort(key=lambda student: student["Full Name"])
...
def students_failing(students_data):
    ...
    for students in students_data:
        ...
        if students["Grades"]["Spanish"] < 60 or students["Grades"]["English"] < 60 or students["Grades"]["Social"] < 60 or students["Grades"]["Science"] < 60:
            ...
            failing_student_data = {"Full Name": students["Full Name"],
...
def student_exists(students_data, name, section):
    ...
    for students in students_data:
        if students["Full Name"].lower() == name.lower() and students["Section"].lower() == section.lower():
            return True
    return False
